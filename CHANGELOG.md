...
* Doc: Explain with example how to enable shell completion [Pierre Kancir]
* Completion: move bash completion into directory and add zsh completion [Pierre Kancir]
* Install-linux: add example for PATH modification [Pierre Kancir]
